...
5. Crie uma classe agora para testar a máquina de café, afinal de contas, você deve evitar entregar código-fonte com bugs. Crie uma nova classe chamada "Orientacao_A_Obejetos_Parte_2.TesteMaquinaCafe" que instancia uma "MaquinaCafe" e atribui a quantidade de açúcar disponível.
...
public class MaquinaDeCafe {
    ...
    public void fazercafe(int quantidadeDeazucar){

        if (azucarDisponivel < quantidadeDeazucar){
            System.out.println("nao ha azucar suficiente pra fazer cafe.");
        }else{
            azucarDisponivel -= quantidadeDeazucar;
            System.out.println("fazer cafe com " + quantidadeDeazucar + " gramas de azucar. ");
